...
As publically funded researchers, we have an obligation for our results to be as transparent and accessible as possible. At the NIH we should strive for [Open Science](https://www.nnlm.gov/guides/data-glossary/open-science), where data and associated methods are accessible. For data analysis, this means we want our pipelines to be accessible as possible, essentially a turn-key system that anyone with the input data (which should be deposited in a public archive) should be able to reproduce the results. Fully implementing the following framework spearheads the fight against the [reproducibility crisis](https://www.nature.com/articles/533452a)

## Sections

0. [Introduction](docs/index.md)
1. [Biowulf](docs/biowulf.md)
2. [VSCode](docs/vscode.md)
3. [Python](docs/python_intro.md)
4. [Anaconda](docs/anaconda.md)
